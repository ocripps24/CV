...
---| --- | --- | --- | --- |
**[React Training](https://github.com/ocripps24/react-training)** | A series of React projects including a simple YouTube clone taken since leaving Makers to learn React fundamentals, how to structure applications, working with Redux, interacting with various APIs, etc. | React, Redux | Educational Mini Projects | See Repo |
